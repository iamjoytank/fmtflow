...
### Added
- `preset()` — create reusable formatter templates; returns a fully chainable `FormatBuilder` callable as a function
...
[1.3.0]: https://github.com/iamjoytank/fmtflow/compare/v1.2.0...v1.3.0
